...
export class Service {
  ...
  async createPost({ title, slug, content, featuredImage, featuredImage2, featuredImage3, status, userId, author, likes = 0 }) {
    try {
  ...
  async updatePost(slug, { title, content, featuredImage, featuredImage2, featuredImage3, status, author, likes }) {
    try {
